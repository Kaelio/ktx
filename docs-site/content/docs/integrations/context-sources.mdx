...
description: Ingest semantic context from dbt, MetricFlow, LookML, Metabase, Looker, Notion, and Jira.
---
...
|-------|----------|-------------|
| `driver` | Yes | Source connector: `dbt`, `metricflow`, `lookml`, `metabase`, `looker`, `notion`, or `jira` |
