...
description: Ingest semantic context from dbt, MetricFlow, LookML, Metabase, Looker, Notion, and Sigma.
---
...
|-------|----------|-------------|
| `driver` | Yes | Source connector: `dbt`, `metricflow`, `lookml`, `metabase`, `looker`, `notion`, or `sigma` |
...
- Unlike Metabase and Looker, Sigma does not require a warehouse mapping step — data models are self-contained
